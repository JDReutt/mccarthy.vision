(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'prop-types', 'react-dom', 'classnames', 'react-prop-types/lib/deprecated', '../constants/media', '../constants/CSSTransitionGroupTick', '../utils/getField', '../utils/mapToListParts', '../utils/PropTypes/controlled', '../Papers/Paper', '../Helpers/Portal', '../Lists/List', './isType', './DrawerTypes'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('prop-types'), require('react-dom'), require('classnames'), require('react-prop-types/lib/deprecated'), require('../constants/media'), require('../constants/CSSTransitionGroupTick'), require('../utils/getField'), require('../utils/mapToListParts'), require('../utils/PropTypes/controlled'), require('../Papers/Paper'), require('../Helpers/Portal'), require('../Lists/List'), require('./isType'), require('./DrawerTypes'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.propTypes, global.reactDom, global.classnames, global.deprecated, global.media, global.CSSTransitionGroupTick, global.getField, global.mapToListParts, global.controlled, global.Paper, global.Portal, global.List, global.isType, global.DrawerTypes);
    global.Drawer = mod.exports;
  }
})(this, function (exports, _react, _propTypes, _reactDom, _classnames, _deprecated, _media, _CSSTransitionGroupTick, _getField, _mapToListParts, _controlled, _Paper, _Portal, _List, _isType, _DrawerTypes) {
  'use strict';
    ...
    _createClass(Drawer, [{
      ...
      value: function render() {
        ...
        var _props2 = this.props,
            ...
            props = _objectWithoutProperties(_props2, ['style', 'className', 'navStyle', 'navClassName', 'component', 'navItems', 'header', 'children', 'inline', 'position', 'overlay', 'clickableDesktopOverlay', 'lastChild', 'portal', 'type', 'visible', 'renderNode', 'constantType', 'defaultVisible', 'defaultMedia', 'mobileType', 'mobileMinWidth', 'tabletType', 'tabletMinWidth', 'desktopType', 'desktopMinWidth', 'transitionDuration', 'onMediaTypeChange', 'onVisibilityChange', 'autoclose', 'autocloseAfterInk', 'onVisibilityToggle', 'closeOnNavItemClick']);
  ...
  var _initialiseProps = function _initialiseProps() {
    ...
    this._updateType = function (props) {
      ...
      if (typeof props.type !== 'undefined') {
        var _state2 = state,
            type = _state2.type,
            realState = _objectWithoutProperties(_state2, ['type']);
