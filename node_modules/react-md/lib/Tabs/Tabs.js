(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'prop-types', 'react-dom', 'classnames', 'react-prop-types/lib/isRequiredForA11y', '../constants/media', '../utils/getField', '../utils/PropTypes/controlled', './TabIndicator', '../Helpers/IconSeparator', '../FontIcons/FontIcon', './MenuTab', './TabOverflowButton'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('prop-types'), require('react-dom'), require('classnames'), require('react-prop-types/lib/isRequiredForA11y'), require('../constants/media'), require('../utils/getField'), require('../utils/PropTypes/controlled'), require('./TabIndicator'), require('../Helpers/IconSeparator'), require('../FontIcons/FontIcon'), require('./MenuTab'), require('./TabOverflowButton'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.propTypes, global.reactDom, global.classnames, global.isRequiredForA11y, global.media, global.getField, global.controlled, global.TabIndicator, global.IconSeparator, global.FontIcon, global.MenuTab, global.TabOverflowButton);
    global.Tabs = mod.exports;
  }
})(this, function (exports, _react, _propTypes, _reactDom, _classnames, _isRequiredForA11y, _media, _getField, _controlled, _TabIndicator, _IconSeparator, _FontIcon, _MenuTab, _TabOverflowButton) {
  'use strict';
    ...
    _createClass(Tabs, [{
      ...
      value: function render() {
        ...
        var _props = this.props,
            ...
            props = _objectWithoutProperties(_props, ['component', 'style', 'className', 'colored', 'centered', 'tabId', 'overflowMenu', 'overflowMenuLabel', 'overflowMenuIconChildren', 'overflowMenuIconClassName', 'nextIconChildren', 'nextIconClassName', 'previousIconChildren', 'previousIconClassName', 'activeTabIndex', 'defaultTabIndex', 'defaultMedia', 'desktopMinWidth', 'onTabChange']);
  ...
  var _initialiseProps = function _initialiseProps() {
    ...
    this._setContainer = function (container) {
      ...
      _this3._positionElements(_this3._container !== null);
    };

    this._positionElements = function (initialRender) {
      ...
      var mobile = _this3._isMobile(_this3.props);

      var paddingLeft = void 0;
      if (!centered && _this3._shouldAlign(_this3.props)) {
        paddingLeft = _this3._calcPaddingLeft(_this3._container, mobile);
      }

      var overflowAtIndex = void 0;
      if (!mobile) {
        overflowAtIndex = _this3._calcOverflowIndex(_this3._container, paddingLeft, overflowMenu);
      }

      var indicatorPosition = _this3._calcIndicatorPosition(_this3._container, initialRender ? paddingLeft : 0);

      _this3.setState(_extends({ mobile: mobile, paddingLeft: paddingLeft, overflowAtIndex: overflowAtIndex }, indicatorPosition), _this3._scrollActiveIntoView);
    };

    this._scrollActiveIntoView = function () {
      if (!_this3._container || !_this3.state.mobile) {
        return;
      }

      var active = _this3._container.querySelector('.md-tab--active');
      if (!active) {
        return;
      }

      var allTabs = Array.prototype.slice.call(_this3._container.querySelectorAll('.md-tab'));
      if (allTabs[0] === active) {
        _this3._container.scrollLeft = 0;
        return;
      }

      var _container = _this3._container,
      ...
      _this3._container.scrollLeft = offset;
    };

    this._handleTabChange = function (index, tabId, tabControlsId, tabChildren, event) {
      if (_this3.props.onTabChange) {
        _this3.props.onTabChange(index, tabId, tabControlsId, tabChildren, event);
      }

      if (typeof _this3.props.activeTabIndex === 'undefined') {
        _this3.setState(_extends({
          activeTabIndex: index
        }, _this3._calcIndicatorPosition(_this3._container, 0, index, _this3.state.overflowAtIndex)));
      }
    };

    this._mapToOverflowTabProps = function (tab, i) {
      var index = i + _this3.state.overflowAtIndex;
      var active = (0, _getField2.default)(_this3.props, _this3.state, 'activeTabIndex') === index;
      var tabEl = _react.Children.only(tab);
      var handleTabChange = _this3._handleTabChange;
    ...
    this._nextIndexes = function (increment) {
    ...
    this._showNextTabs = function () {
      _this3._nextIndexes(true);
    };

    this._showPreviousTabs = function () {
      _this3._nextIndexes(false);
    };
  };
