(function (global, factory) {
  ...
  var TooltipContainer = function (_PureComponent) {
    ...
    function TooltipContainer() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = TooltipContainer.__proto__ || Object.getPrototypeOf(TooltipContainer)).call.apply(_ref, [this].concat(args))), _this), _this.state = { visible: false }, _this._delayedTimeout = null, _this._setContainers = function (container) {
        if (container) {
          _this._container = (0, _reactDom.findDOMNode)(container).parentNode;

          _this._container.addEventListener('mouseover', _this._showTooltip);
          _this._container.addEventListener('mouseleave', _this._hideTooltip);
          _this._container.addEventListener('touchstart', _this._showTooltip);
          _this._container.addEventListener('touchend', _this._hideTooltip);
          _this._container.addEventListener('keyup', _this._handleKeyUp);
          _this._container.addEventListener('blur', _this._hideTooltip);
        }
