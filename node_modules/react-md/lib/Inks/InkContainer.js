(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'prop-types', 'react-dom', 'react-transition-group/TransitionGroup', 'classnames', '../constants/keyCodes', '../utils/calcPageOffset', '../utils/isFormPartRole', '../utils/EventUtils/isValidClick', '../utils/EventUtils/captureNextEvent', '../utils/NumberUtils/calculateHypotenuse', './Ink'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('prop-types'), require('react-dom'), require('react-transition-group/TransitionGroup'), require('classnames'), require('../constants/keyCodes'), require('../utils/calcPageOffset'), require('../utils/isFormPartRole'), require('../utils/EventUtils/isValidClick'), require('../utils/EventUtils/captureNextEvent'), require('../utils/NumberUtils/calculateHypotenuse'), require('./Ink'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.propTypes, global.reactDom, global.TransitionGroup, global.classnames, global.keyCodes, global.calcPageOffset, global.isFormPartRole, global.isValidClick, global.captureNextEvent, global.calculateHypotenuse, global.Ink);
    global.InkContainer = mod.exports;
  }
})(this, function (exports, _react, _propTypes, _reactDom, _TransitionGroup, _classnames, _keyCodes, _calcPageOffset, _isFormPartRole, _isValidClick, _captureNextEvent, _calculateHypotenuse, _Ink) {
  'use strict';
  ...
  var InkContainer = function (_PureComponent) {
    ...
    function InkContainer() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = InkContainer.__proto__ || Object.getPrototypeOf(InkContainer)).call.apply(_ref, [this].concat(args))), _this), _this.state = { inks: [] }, _this.createInk = function (pageX, pageY) {
      ...
      }, _this._setContainers = function (inkContainer) {
        if (inkContainer !== null) {
          _this._inkContainer = (0, _reactDom.findDOMNode)(inkContainer);
        ...
        if (keyboardDiff) {
          ...
          if (touchDiff) {
            _this._container[(touchDisabled ? 'add' : 'remove') + 'EventListener']('touchstart', _this._stopPropagationToFocus);
          }
        }
        ...
        if (touchDiff) {
          ...
          _this._container[_fn2]('touchstart', _this._handleTouchStart);
          _this._container[_fn2]('touchend', _this._handleTouchEnd);
        }
        ...
        _this._clicked = mousedown || type === 'touchstart';

        if (_this._clicked) {
          window.addEventListener(mousedown ? 'mouseup' : 'touchend', _this._stopPropagationToFocus, true);
        } else {
          window.removeEventListener(e.type, _this._stopPropagationToFocus, true);
        }
