(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'prop-types', '../utils/getField', '../utils/StringUtils/getDisplayName', './InkContainer', './inkContextTypes'], factory);
      ...
      _createClass(InkedComponent, [{
        ...
        value: function render() {
          var _props = this.props,
              ...
              props = _objectWithoutProperties(_props, ['inkTransitionOverlap', 'inkTransitionEnterTimeout', 'inkTransitionLeaveTimeout', 'inkStyle', 'inkClassName', 'inkContainerStyle', 'inkContainerClassName', 'waitForInkTransition', 'disabledInteractions', 'inkDisabled', '__SUPER_SECRET_REF__']);
