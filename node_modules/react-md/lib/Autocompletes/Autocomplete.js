(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'prop-types', 'react-dom', 'react-transition-group/CSSTransitionGroup', 'classnames', '../utils/getField', '../utils/omit', '../utils/findIgnoreCase', '../utils/fuzzyFilter', '../utils/caseInsensitiveFilter', '../utils/PropTypes/oneRequiredForA11y', '../utils/PropTypes/controlled', '../utils/PropTypes/invalidIf', '../constants/keyCodes', '../Helpers/anchorShape', '../Helpers/fixedToShape', '../Helpers/positionShape', '../Lists/ListItem', '../Menus/Menu', '../TextFields/TextField'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('prop-types'), require('react-dom'), require('react-transition-group/CSSTransitionGroup'), require('classnames'), require('../utils/getField'), require('../utils/omit'), require('../utils/findIgnoreCase'), require('../utils/fuzzyFilter'), require('../utils/caseInsensitiveFilter'), require('../utils/PropTypes/oneRequiredForA11y'), require('../utils/PropTypes/controlled'), require('../utils/PropTypes/invalidIf'), require('../constants/keyCodes'), require('../Helpers/anchorShape'), require('../Helpers/fixedToShape'), require('../Helpers/positionShape'), require('../Lists/ListItem'), require('../Menus/Menu'), require('../TextFields/TextField'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.propTypes, global.reactDom, global.CSSTransitionGroup, global.classnames, global.getField, global.omit, global.findIgnoreCase, global.fuzzyFilter, global.caseInsensitiveFilter, global.oneRequiredForA11y, global.controlled, global.invalidIf, global.keyCodes, global.anchorShape, global.fixedToShape, global.positionShape, global.ListItem, global.Menu, global.TextField);
    global.Autocomplete = mod.exports;
  }
})(this, function (exports, _react, _propTypes, _reactDom, _CSSTransitionGroup, _classnames, _getField, _omit, _findIgnoreCase, _fuzzyFilter, _caseInsensitiveFilter, _oneRequiredForA11y, _controlled, _invalidIf, _keyCodes, _anchorShape, _fixedToShape, _positionShape, _ListItem, _Menu, _TextField) {
  'use strict';
    ...
    _createClass(Autocomplete, [{
      ...
      value: function render() {
        ...
        var _props = this.props,
            ...
            props = _objectWithoutProperties(_props, ['fullWidth', 'block', 'style', 'className', 'listStyle', 'listClassName', 'textFieldStyle', 'textFieldClassName', 'menuId', 'inline', 'anchor', 'belowAnchor', 'position', 'fixedTo', 'listId', 'listInline', 'listZDepth', 'listHeightRestricted', 'xThreshold', 'yThreshold', 'closeOnOutsideClick', 'transitionName', 'transitionEnterTimeout', 'transitionLeaveTimeout', 'centered', 'sameWidth', 'value', 'total', 'offset', 'filter', 'data', 'dataLabel', 'dataValue', 'deleteKeys', 'defaultValue', 'clearOnAutocomplete', 'autocompleteWithLabel', 'findInlineSuggestion', 'onAutocomplete', 'onMenuOpen', 'onMenuClose', 'onBlur', 'onFocus', 'onKeyDown', 'onMouseDown', 'onChange']);
  ...
  var _initialiseProps = function _initialiseProps() {
    ...
    this._updateSuggestionStyle = function (isNew, isDeleted) {
      var suggestionStyle = _this2.state.suggestionStyle;

      if (isNew) {
        var msg = (0, _reactDom.findDOMNode)(_this2).querySelector('.md-text-field-message');

        if (msg) {
          var cs = window.getComputedStyle(_this2._suggestion);
          var bottom = parseInt(cs.bottom, 10) + msg.offsetHeight;

          _this2.setState({ suggestionStyle: _extends({}, suggestionStyle, { bottom: bottom }) });
        }
      } else if (isDeleted && suggestionStyle) {
        _this2.setState({ suggestionStyle: { left: suggestionStyle.left } });
      }
    };

    this._updateFont = function () {
      if (_this2._field) {
        var cs = window.getComputedStyle(_this2._field);
        _this2._fontSize = parseInt(cs.fontSize, 10);
        _this2._font = cs.font;
      }
    };
    ...
    this._handleMenuKeyDown = function (e) {
      ...
      if (key === _keyCodes.TAB) {
        ...
        e.target.click();
        _this2._handleItemClick(_this2.state.matchIndex);
      }
    };
    ...
    this._findInlineSuggestions = function (value) {
      ...
      var font = _this2._font;
      var fontSize = _this2._fontSize;
      var suggestionStyle = _this2.state.suggestionStyle;
    ...
    this._setSuggestion = function (suggestion) {
      _this2._suggestion = suggestion;
    };
  };
