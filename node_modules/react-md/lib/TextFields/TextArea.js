  ...
  var TextArea = function (_PureComponent) {
    ...
    function TextArea() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = TextArea.__proto__ || Object.getPrototypeOf(TextArea)).call.apply(_ref, [this].concat(args))), _this), _this.state = { height: null }, _this.getField = function () {
        ...
        _this._rowHeight = _this._calcRowHeight(_this._field, _this.props);
        ...
        if (_this.props.onHeightChange) {
          ...
          _this.props.onHeightChange(height + 5);
        }
    ...
    _createClass(TextArea, [{
      ...
      value: function render() {
        ...
        var _props = this.props,
            ...
            props = _objectWithoutProperties(_props, ['style', 'defaultValue', 'value', 'className', 'label', 'block', 'maxRows', 'onChange', 'onHeightChange']);
