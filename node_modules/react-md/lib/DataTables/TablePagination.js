(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'prop-types', 'classnames', 'react-dom', '../utils/getField', '../SelectFields/SelectField', '../Buttons/Button', './findTable', './TableFooter', './TableColumn'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('prop-types'), require('classnames'), require('react-dom'), require('../utils/getField'), require('../SelectFields/SelectField'), require('../Buttons/Button'), require('./findTable'), require('./TableFooter'), require('./TableColumn'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.propTypes, global.classnames, global.reactDom, global.getField, global.SelectField, global.Button, global.findTable, global.TableFooter, global.TableColumn);
    global.TablePagination = mod.exports;
  }
})(this, function (exports, _react, _propTypes, _classnames, _reactDom, _getField, _SelectField, _Button, _findTable, _TableFooter, _TableColumn) {
  'use strict';
    ...
    _createClass(TablePagination, [{
      ...
      value: function render() {
        ...
        var _props2 = this.props,
            ...
            props = _objectWithoutProperties(_props2, ['className', 'rows', 'rowsPerPageLabel', 'rowsPerPageItems', 'incrementIconChildren', 'incrementIconClassName', 'decrementIconChildren', 'decrementIconClassName', 'onPagination', 'rowsPerPage', 'page', 'defaultPage', 'defaultRowsPerPage']);
  ...
  var _initialiseProps = function _initialiseProps() {
    ...
    this._setControls = function (controls) {
      _this2._controls = (0, _reactDom.findDOMNode)(controls);
      _this2._table = (0, _findTable2.default)(_this2._controls);
    ...
    this._increment = function () {
      var _props3 = _this2.props,
          rows = _props3.rows,
          onPagination = _props3.onPagination;
