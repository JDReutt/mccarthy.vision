(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'prop-types', 'react-dom', 'classnames', 'react-prop-types/lib/deprecated', '../constants/keyCodes', '../utils/getField', '../utils/PropTypes/controlled', '../Helpers/anchorShape', '../Helpers/fixedToShape', '../Helpers/positionShape', '../Helpers/Layover', '../FontIcons/FontIcon', '../TextFields/TextField', './TableColumn', './EditDialog', './findTable', './findFixedTo'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('prop-types'), require('react-dom'), require('classnames'), require('react-prop-types/lib/deprecated'), require('../constants/keyCodes'), require('../utils/getField'), require('../utils/PropTypes/controlled'), require('../Helpers/anchorShape'), require('../Helpers/fixedToShape'), require('../Helpers/positionShape'), require('../Helpers/Layover'), require('../FontIcons/FontIcon'), require('../TextFields/TextField'), require('./TableColumn'), require('./EditDialog'), require('./findTable'), require('./findFixedTo'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.propTypes, global.reactDom, global.classnames, global.deprecated, global.keyCodes, global.getField, global.controlled, global.anchorShape, global.fixedToShape, global.positionShape, global.Layover, global.FontIcon, global.TextField, global.TableColumn, global.EditDialog, global.findTable, global.findFixedTo);
    global.EditDialogColumn = mod.exports;
  }
})(this, function (exports, _react, _propTypes, _reactDom, _classnames, _deprecated, _keyCodes, _getField, _controlled, _anchorShape, _fixedToShape, _positionShape, _Layover, _FontIcon, _TextField, _TableColumn, _EditDialog, _findTable, _findFixedTo) {
  'use strict';
    ...
    _createClass(EditDialogColumn, [{
      ...
      value: function render() {
        ...
        var _props2 = this.props,
            ...
            props = _objectWithoutProperties(_props2, ['style', 'className', 'layoverStyle', 'layoverClassName', 'dialogStyle', 'dialogClassName', 'dialogContentStyle', 'dialogContentClassName', 'dialogZDepth', 'textFieldStyle', 'textFieldClassName', 'inputClassName', 'large', 'title', 'inline', 'inlineIconChildren', 'inlineIconClassName', 'maxLength', 'noIcon', 'label', 'placeholder', 'header', 'anchor', 'belowAnchor', 'fixedTo', 'animationPosition', 'xThreshold', 'yThreshold', 'centered', 'sameWidth', 'transitionName', 'transitionEnterTimeout', 'transitionLeaveTimeout', 'tooltipLabel', 'tooltipDelay', 'tooltipPosition', 'id', 'dialogId', 'cellIndex', 'onOkClick', 'okLabel', 'okPrimary', 'okSecondary', 'onCancelClick', 'cancelLabel', 'cancelPrimary', 'cancelSecondary', 'okOnOutsideClick', 'defaultValue', 'adjusted', 'scrollThreshold', 'enforceMinWidth', 'transitionDuration']);
  ...
  var _initialiseProps = function _initialiseProps() {
    ...
    this._handleOpen = function () {
      if (_this2._skipNextOpen) {
        ...
        if (_this2._table && _this2._column && !_this2.props.inline) {
          _this2._table.scrollLeft = _this2._column.offsetLeft;
        }
    ...
    this._handleClose = function (e) {
      var _props4 = _this2.props,
          onOutsideClick = _props4.onOutsideClick,
          okOnOutsideClick = _props4.okOnOutsideClick;
