    ...
    function NavigationDrawer(props) {
      ...
      _this._toggleVisibility = function (e) {
        var _this$props = _this.props,
            onVisibilityToggle = _this$props.onVisibilityToggle,
            onVisibilityChange = _this$props.onVisibilityChange,
            onDrawerChange = _this$props.onDrawerChange;
      ...
      _this._handleVisibility = function (visible) {
        var _this$props2 = _this.props,
            onVisibilityToggle = _this$props2.onVisibilityToggle,
            onVisibilityChange = _this$props2.onVisibilityChange,
            onDrawerChange = _this$props2.onDrawerChange;
      ...
      _this._handleTypeChange = function (drawerType, mediaState) {
        var onMediaTypeChange = _this.props.onMediaTypeChange;
        ...
        if (typeof _this.props.drawerType === 'undefined') {
    ...
    _createClass(NavigationDrawer, [{
      ...
      value: function render() {
        var _props2 = this.props,
            ...
            props = _objectWithoutProperties(_props2, ['style', 'className', 'toolbarStyle', 'toolbarClassName', 'drawerStyle', 'drawerClassName', 'contentStyle', 'contentClassName', 'contentComponent', 'navItems', 'children', 'drawerTitle', 'drawerChildren', 'drawerHeaderChildren', 'drawerTransitionDuration', 'toolbarTitle', 'toolbarTitleMenu', 'toolbarTitleStyle', 'toolbarTitleClassName', 'toolbarActions', 'toolbarProminent', 'toolbarProminentTitle', 'toolbarThemeType', 'toolbarSingleColor', 'toolbarChildren', 'toolbarZDepth', 'mobileDrawerType', 'tabletDrawerType', 'desktopDrawerType', 'transitionName', 'transitionEnterTimeout', 'transitionLeaveTimeout', 'extractMini', 'miniDrawerHeader', 'miniDrawerChildren', 'temporaryIconChildren', 'temporaryIconClassName', 'menuIconChildren', 'menuIconClassName', 'footer', 'includeDrawerHeader', 'contentId', 'contentProps', 'constantDrawerType', 'drawerType', 'drawerHeader', 'renderNode', 'jumpLabel', 'persistentIconChildren', 'persistentIconClassName', 'onDrawerChange', 'closeIconChildren', 'closeIconClassName']);
