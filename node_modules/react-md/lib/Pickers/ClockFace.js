(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'prop-types', '../utils/EventUtils/isValidClick', '../utils/EventUtils/captureNextEvent', '../utils/NumberUtils/calcTimeFromPoint', '../utils/calcPageOffset', './ClockTime', './ClockHand'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('prop-types'), require('../utils/EventUtils/isValidClick'), require('../utils/EventUtils/captureNextEvent'), require('../utils/NumberUtils/calcTimeFromPoint'), require('../utils/calcPageOffset'), require('./ClockTime'), require('./ClockHand'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.propTypes, global.isValidClick, global.captureNextEvent, global.calcTimeFromPoint, global.calcPageOffset, global.ClockTime, global.ClockHand);
    global.ClockFace = mod.exports;
  }
})(this, function (exports, _react, _propTypes, _isValidClick, _captureNextEvent, _calcTimeFromPoint, _calcPageOffset, _ClockTime, _ClockHand) {
  'use strict';
  ...
  var ClockFace = function (_PureComponent) {
    ...
    function ClockFace(props) {
      ...
      _this._handleTouchEnd = function (e) {
        ...
        window.removeEventListener('touchend', _this._handleTouchEnd);
