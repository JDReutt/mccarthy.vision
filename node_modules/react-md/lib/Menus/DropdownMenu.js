(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'prop-types', '../utils/PropTypes/controlled', '../utils/mapToListParts', '../utils/getField', '../Helpers/anchorShape', '../Helpers/fixedToShape', '../Helpers/positionShape', './Menu'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('prop-types'), require('../utils/PropTypes/controlled'), require('../utils/mapToListParts'), require('../utils/getField'), require('../Helpers/anchorShape'), require('../Helpers/fixedToShape'), require('../Helpers/positionShape'), require('./Menu'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.propTypes, global.controlled, global.mapToListParts, global.getField, global.anchorShape, global.fixedToShape, global.positionShape, global.Menu);
    global.DropdownMenu = mod.exports;
  }
})(this, function (exports, _react, _propTypes, _controlled, _mapToListParts, _getField, _anchorShape, _fixedToShape, _positionShape, _Menu) {
  'use strict';
    ...
    _createClass(DropdownMenu, [{
      ...
      value: function render() {
        var _props = this.props,
            ...
            props = _objectWithoutProperties(_props, ['id', 'listId', 'menuItems', 'children', 'visible', 'onVisibilityChange', 'defaultVisible']);
