(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'prop-types', 'react-dom', 'classnames', 'react-prop-types/lib/deprecated', 'react-prop-types/lib/isRequiredForA11y', '../constants/CSSTransitionGroupTick', '../utils/getField', '../utils/EventUtils/handleKeyboardAccessibility', '../Helpers/anchorShape', '../Helpers/fixedToShape', '../Helpers/positionShape', '../Helpers/Layover', '../Lists/List'], factory);
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Menu.__proto__ || Object.getPrototypeOf(Menu)).call.apply(_ref, [this].concat(args))), _this), _this._handleClose = function (e) {
        ...
        while (_this._container && _this._container.contains(node)) {
          if (node.classList.contains('md-list-control')) {
            return;
          } else if (!node.classList.contains('md-list-item--nested-container') && node.classList.contains('md-list-item')) {
            e.persist();
    ...
    _createClass(Menu, [{
      ...
      value: function render() {
        var _props2 = this.props,
            ...
            props = _objectWithoutProperties(_props2, ['id', 'className', 'listStyle', 'listClassName', 'visible', 'children', 'listProps', 'listZDepth', 'listInline', 'listHeightRestricted', 'sameWidth', 'contained', 'isOpen', 'fixedTo', 'listId', 'cascading', 'cascadingAnchor', 'cascadingZDepth', 'onClose', 'position', 'close', 'autoclose', 'limitHeight', 'expanderIconChildren', 'expanderIconClassName']);
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _extends({}, listProps, {
              ...
              key: 'menu-list',
              style: listStyle,
              className: (0, _classnames2.default)('md-list--menu', _defineProperty({
                'md-list--menu-restricted': listHeightRestricted
              }, 'md-paper md-paper--' + listZDepth, listZDepth), listClassName),
              inline: listInline
            }),
            children
          )
  ...
  Menu.Positions = {
    ...
    get CONTEXT() {
      if (!this._warned) {
        ...
        console.error('The `Menu.Positions.CONTEXT` position has been depreacted and will be removed ' + 'in the next major release. To make the `Menu` behave as a context menu, provide ' + 'the `onContextMenu` prop instead.');
      }
