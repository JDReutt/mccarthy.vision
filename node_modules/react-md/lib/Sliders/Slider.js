(function (global, factory) {
  ...
  var _initialiseProps = function _initialiseProps() {
    ...
    this._isTextField = function (target) {
      return _this2._textField && _this2._textField.contains(target);
    };
    ...
    this._handleDragStart = function (e) {
      ...
      if (_this2.props.disabled || e.type === 'mousedown' && !(0, _isValidClick2.default)(e, 'mousedown') || e.target.className.match(/text-field/)) {
        return;
      }
    ...
    this._calcTrackWidth = function (props) {
      ...
      if (!leftIcon && !rightIcon && !editable) {
        ...
        var cs = window.getComputedStyle(_this2._textField);
