(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'prop-types', 'classnames', 'react-prop-types/lib/deprecated', 'react-prop-types/lib/isRequiredForA11y', '../utils/getField', '../utils/PropTypes/oneRequiredForA11y', '../utils/StringUtils/capitalizeFirst', '../Helpers/AccessibleFakeInkedButton', '../FontIcons/FontIcon', './SwitchTrack'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('prop-types'), require('classnames'), require('react-prop-types/lib/deprecated'), require('react-prop-types/lib/isRequiredForA11y'), require('../utils/getField'), require('../utils/PropTypes/oneRequiredForA11y'), require('../utils/StringUtils/capitalizeFirst'), require('../Helpers/AccessibleFakeInkedButton'), require('../FontIcons/FontIcon'), require('./SwitchTrack'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.propTypes, global.classnames, global.deprecated, global.isRequiredForA11y, global.getField, global.oneRequiredForA11y, global.capitalizeFirst, global.AccessibleFakeInkedButton, global.FontIcon, global.SwitchTrack);
    global.SelectionControl = mod.exports;
  }
})(this, function (exports, _react, _propTypes, _classnames, _deprecated, _isRequiredForA11y, _getField, _oneRequiredForA11y, _capitalizeFirst, _AccessibleFakeInkedButton, _FontIcon, _SwitchTrack) {
  'use strict';
    ...
    function SelectionControl(props) {
      ...
      _this._getIcon = function () {
        ...
        return _react2.default.createElement(
          _FontIcon2.default,
          { iconClassName: _this.props[prefix + 'ClassName'] },
          _this.props[prefix + 'Children']
        );
      };
      ...
      _this._handleChange = function (e) {
        ...
        if (!_this._fromFakeButton && type !== 'switch' && typeof _this._control.createInk === 'function') {
          // create ink doesn't exist when testing atm
          _this._control.createInk();
        }
        _this._fromFakeButton = false;
      ...
      _this._handleControlClick = function () {
        _this._fromFakeButton = true;
        // Trigger the change
        _this._input.click();
      };
    ...
    _createClass(SelectionControl, [{
      ...
      value: function render() {
        var _props = this.props,
            ...
            props = _objectWithoutProperties(_props, ['id', 'style', 'className', 'inline', 'type', 'name', 'value', 'disabled', 'labelBefore', 'onBlur', 'onFocus', 'tabIndex', 'inkDisabled', 'disabledInteractions', 'aria-label', 'label', 'checked', 'onChange', 'checkedIcon', 'uncheckedIcon', 'checkedRadioIconChildren', 'checkedRadioIconClassName', 'uncheckedRadioIconChildren', 'uncheckedRadioIconClassName', 'checkedCheckboxIconChildren', 'checkedCheckboxIconClassName', 'uncheckedCheckboxIconChildren', 'uncheckedCheckboxIconClassName', 'tooltip', '__superSecreteProp']);
  ...
  SelectionControl.propTypes = {
     ...
     */
    'aria-label': (0, _oneRequiredForA11y2.default)(_propTypes2.default.string, 'label'),
