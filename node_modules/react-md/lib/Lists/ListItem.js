(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'prop-types', 'react-dom', 'classnames', 'react-prop-types/lib/deprecated', '../utils/getField', '../utils/PropTypes/controlled', '../constants/keyCodes', '../Helpers/anchorShape', '../Helpers/fixedToShape', '../Helpers/AccessibleFakeInkedButton', '../Helpers/Collapse', '../FontIcons/Collapser', './TileAddon', './ListItemText', './List', '../Menus/Menu'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('prop-types'), require('react-dom'), require('classnames'), require('react-prop-types/lib/deprecated'), require('../utils/getField'), require('../utils/PropTypes/controlled'), require('../constants/keyCodes'), require('../Helpers/anchorShape'), require('../Helpers/fixedToShape'), require('../Helpers/AccessibleFakeInkedButton'), require('../Helpers/Collapse'), require('../FontIcons/Collapser'), require('./TileAddon'), require('./ListItemText'), require('./List'), require('../Menus/Menu'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.propTypes, global.reactDom, global.classnames, global.deprecated, global.getField, global.controlled, global.keyCodes, global.anchorShape, global.fixedToShape, global.AccessibleFakeInkedButton, global.Collapse, global.Collapser, global.TileAddon, global.ListItemText, global.List, global.Menu);
    global.ListItem = mod.exports;
  }
})(this, function (exports, _react, _propTypes, _reactDom, _classnames, _deprecated, _getField, _controlled, _keyCodes, _anchorShape, _fixedToShape, _AccessibleFakeInkedButton, _Collapse, _Collapser, _TileAddon, _ListItemText, _List, _Menu) {
  'use strict';
  ...
  var ListItem = function (_PureComponent) {
    ...
    _createClass(ListItem, [{
      ...
      value: function render() {
        ...
        if (nestedItems) {
          ...
          var collapser = _react2.default.createElement(_TileAddon2.default, {
            ...
            icon: _react2.default.createElement(
              _Collapser2.default,
              { flipped: visible, iconClassName: expanderIconClassName },
        ...
        var sharedProps = _extends({}, itemProps, {
          style: style,
