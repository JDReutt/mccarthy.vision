(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'prop-types', 'classnames', 'react-prop-types/lib/deprecated', '../utils/getField', '../utils/PropTypes/controlled', '../Helpers/Portal', '../Papers/Paper', './BottomNav'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('prop-types'), require('classnames'), require('react-prop-types/lib/deprecated'), require('../utils/getField'), require('../utils/PropTypes/controlled'), require('../Helpers/Portal'), require('../Papers/Paper'), require('./BottomNav'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.propTypes, global.classnames, global.deprecated, global.getField, global.controlled, global.Portal, global.Paper, global.BottomNav);
    global.BottomNavigation = mod.exports;
  }
})(this, function (exports, _react, _propTypes, _classnames, _deprecated, _getField, _controlled, _Portal, _Paper, _BottomNav) {
  'use strict';
  ...
  var _initialiseProps = function _initialiseProps() {
    ...
    this._addTouchEvents = function () {
      window.addEventListener('touchstart', _this3._handleTouchStart);
      window.addEventListener('touchmove', _this3._handleTouchMove);
      window.addEventListener('touchend', _this3._handleTouchEnd);
    };

    this._removeTouchEvents = function () {
      window.removeEventListener('touchstart', _this3._handleTouchStart);
      window.removeEventListener('touchmove', _this3._handleTouchMove);
      window.removeEventListener('touchend', _this3._handleTouchEnd);
    };
    ...
    this._handleTouchMove = function (e) {
      ...
      var _props2 = _this3.props,
          ...
          dynamicThreshold = _props2.dynamicThreshold;
