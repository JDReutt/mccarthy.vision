(function (global, factory) {
  ...
  var ExpansionList = function (_PureComponent) {
    ...
    function ExpansionList() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ExpansionList.__proto__ || Object.getPrototypeOf(ExpansionList)).call.apply(_ref, [this].concat(args))), _this), _this.state = { columnWidths: [], focusedIndex: -1 }, _this._setContainer = function (container) {
        if (container !== null) {
        ...
        var columnWidths = Array.prototype.slice.call(_this._container.querySelectorAll('.md-panel-header')).reduce(function (maxes, row) {
    ...
    _createClass(ExpansionList, [{
      ...
      value: function render() {
        ...
        var _props = this.props,
            ...
            props = _objectWithoutProperties(_props, ['children', 'className', 'component', 'animateContent']);
